...
const NAVIGATION_ITEMS = [
  ...
  { icon: Coins, label: '用量与费用', path: '/app/support', keywords: ['usage', 'cost', 'billing', 'token'] },
]

const SECONDARY_ITEMS = [
  { icon: Radar, label: '店铺', path: '/app/compliance/system', keywords: ['shop', 'store', 'system', 'compliance'] },
  { icon: PackageCheck, label: '产品', path: '/app/products', keywords: ['product', 'compliance'] },
